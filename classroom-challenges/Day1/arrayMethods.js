...
//Reverse Method
/*
    The Reverse method reverses the order of the elements in an array. It sorts it in decending order.
*/
...
//splitting by whitespace/single blank space.
...
let darkSide = ['Darth Vader', 'Darth Plagueis', 'Emperor Palpatine', 'Count Dooku', 'General Greivious', 'Kylo Ren', 'Darth Maul'];
...
let wheelOfTime = [
    ...
    {firstname : "Eqwene", lastname: "al'Vere"},
